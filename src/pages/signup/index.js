		...
		<div className="flex h-screen w-full items-center justify-center  px-2 md:px-0">
			<div className="w-full max-w-[456px]">
				...
				<div className="my-6 text-center text-[28px] font-extrabold md:text-[32px] ">
					Create a <span className="text-red">FREE </span> account
				</div>
				<div className="text-center  text-[16px] text-black">
					You have already saved 4.5 hours. Sign up to continue to protect your
					valuable free time and enjoy your life.
				</div>
				<form
					action=""
